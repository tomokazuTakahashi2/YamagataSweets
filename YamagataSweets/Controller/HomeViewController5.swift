...
//MARK:-グルナビAPI
    func getAPI(){
        ...
        //URLを生成
        guard let url = URL(string: "https://api.gnavi.co.jp/RestSearchAPI/v3/?keyid=ffd3c1155ff596e65e9d4cf8db64eb85&freeword=%E3%82%AB%E3%83%95%E3%82%A7&pref=PREF06&hit_per_page=100&offset_page=5") else {return}
